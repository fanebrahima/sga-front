...
export class ListClientComponent implements OnInit {
  ...
  getItems(){
    this.clientService.getClient(this.current_page).subscribe((data: any) => {
      this.listItem = data.clients.data;

      this.current_page = data.clients.current_page;
      this.first_page_url = data.clients.first_page_url;
      this.from = data.clients.from;
      this.last_page = data.clients.last_page;
      this.last_page_url = data.clients.last_page_url;
      this.links = data.clients.links;
      this.next_page_url = data.clients.next_page_url;
      this.per_page = data.clients.per_page;
      this.prev_page_url = data.clients.prev_page_url;
      this.to = data.clients.to;
  ...
  search(){
    this.SpinnerService.show();
    this.clientService.getClientSearch(this.current_page,this.information).subscribe((data: any) => {
      this.listItem = data.clients.data;
  ...
  paginate(){
    if(this.information){
      ...
      this.SpinnerService.show();
      this.clientService.getClientPaginate(this.current_page).subscribe((data: any) => {
        this.listItem = data.clients.data;
  ...
  save(): void {
    ...
    if (this.formGroupAdd.invalid) {
      ...
      this.clientService.add(formData).subscribe(res => {
        this.message = res;
  ...
  enable(){
    ...
    this.clientService.enable(formData).subscribe(res => {
      this.message = res;
      if(this.message.success == false){
        this.error_message = this.message.message;
        this.submit = false;
  ...
  disable(){
    ...
    this.clientService.disable(formData).subscribe(res => {
      this.message = res;
      if(this.message.success == false){
        this.error_message = this.message.message;
        this.submit = false;
  ...
  update(){
    ...
    this.clientService.update(formData).subscribe(res => {
      this.message = res;
      if(this.message.success == false){
        this.submit = false;
        this.error_message = this.message.message;
